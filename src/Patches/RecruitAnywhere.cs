...
internal static class RecruitAnywhere_Begin
{
    ...
    {
        RecruitAnywhereSession.BeginIfNeeded();
    }
...
internal static class RecruitAnywhere_End_Deactivate
{
    [HarmonyPostfix] private static void Postfix() => RecruitAnywhereSession.End();
}

[HarmonyPatch(typeof(TaleWorlds.CampaignSystem.ViewModelCollection.GameMenu.Recruitment.RecruitmentVM), "OnFinalize")]
internal static class RecruitAnywhere_End_Finalize
{
    [HarmonyPostfix] private static void Postfix() => RecruitAnywhereSession.End();
}

internal static class RecruitAnywhereSession
{
    ...
    public static void BeginIfNeeded()
    {
        ...
        Log.Debug($"[RecruitAnywhere] Temporary swap applied at {s.Name}.");
    }
    ...
    public static void End()
    {
        ...
        _backup.Clear();
        Log.Debug($"[RecruitAnywhere] Swap restored at {_settlement?.Name}.");
        _settlement = null;
    }
}
