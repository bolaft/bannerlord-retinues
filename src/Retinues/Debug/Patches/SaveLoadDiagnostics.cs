...
namespace Retinues.Debug.Patches
{
    ...
    internal static class SaveLoadDiagnostics
    {
        ...
        public static void ReportLoadContextException(string text)
        {
            ...
            // This is the critical line: full ToString() includes stack + inner exceptions.
    ...
    internal static class Patch_LoadContext_Load
    {
        ...
        static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions)
        {
            ...
            var report = AccessTools.Method(
                typeof(SaveLoadDiagnostics),
                nameof(SaveLoadDiagnostics.ReportLoadContextException)
            );
    ...
    internal static class Patch_SaveManager_Load
    {
        ...
        {
            SaveLoadDiagnostics.LastSaveName = saveName;
            SaveLoadDiagnostics.LastLoadContextException = null;
        }
        ...
        static void Postfix(string saveName, LoadResult __result)
        {
            ...
            if (!string.IsNullOrEmpty(SaveLoadDiagnostics.LastLoadContextException))
            {
                Log.Error(
    ...
    internal static class Patch_MBSaveLoad_LoadSaveGameData
    {
        ...
        static void Postfix(string saveName, LoadResult __result)
        {
            ...
            var extra = string.IsNullOrEmpty(SaveLoadDiagnostics.LastLoadContextException)
