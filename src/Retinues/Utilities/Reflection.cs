...
namespace Retinues.Utilities
{
    ...
    public static class Reflection
    {
        ...
        /// <summary>
        /// Returns true if the given instance exposes a property with the specified name
        /// (searches base types and non-public members as per Reflection.Flags).
        /// </summary>
        public static bool HasProperty(object instance, string propertyName)
        {
            if (instance == null || string.IsNullOrEmpty(propertyName))
                return false;
            return ResolveProperty(instance.GetType(), propertyName) != null;
        }

        /// <summary>
        /// Returns true if the given instance exposes a field with the specified name
        /// (searches base types and non-public members as per Reflection.Flags).
        /// </summary>
        public static bool HasField(object instance, string fieldName)
        {
            if (instance == null || string.IsNullOrEmpty(fieldName))
                return false;
            return ResolveField(instance.GetType(), fieldName) != null;
        }
