...
namespace Retinues.Features.Formations.Patches
{
    ...
    internal static class FormationQuerySystem_get_MainClass_Patch
    {
        // Your policy: when should a formation be "forced"?
        private static bool TryGetForcedClass(FormationQuerySystem fqs, out FormationClass forced)
        {
            ...
            try
            {
                ...
                // If all (or a large majority) agents in the formation belong to your custom troops.
