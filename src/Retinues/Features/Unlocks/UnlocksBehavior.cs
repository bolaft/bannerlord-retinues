...
namespace Retinues.Features.Unlocks
{
    ...
    public class UnlocksBehavior : CampaignBehaviorBase
    {
        ...
        private void OnMissionStarted(IMission mission)
        {
            ...
            if (!Config.UnlockFromKills || Config.AllEquipmentUnlocked)
                return;
        ...
        {
            // Return if the feature is disabled
            if (!Config.UnlockFromDiscards || Config.AllEquipmentUnlocked)
                return;
        ...
        )
        {
            // Return if the feature is disabled
            if (
                (!Config.UnlockFromKills && !Config.UnlockFromDiscards)
