// File: src/Retinues/Domain/Exports/Services/Import/RetinuesExportParser.cs
...
{
    /// <summary>
    /// Parses Retinues export XML files (format v1, root "Retinues").
    /// </summary>
    public static class RetinuesExportParser
    {
