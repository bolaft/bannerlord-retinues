// File: src/Retinues/Domain/Factions/Services/Import/FactionImportService.cs

using System;
using System.Collections.Generic;
using System.Linq;
using Retinues.Domain.Characters.Services.Import;
using Retinues.Domain.Characters.Wrappers;
using Retinues.Domain.Exports.Services.Import;
using Retinues.Domain.Factions;
using Retinues.Utilities;

namespace Retinues.Domain.Factions.Services.Import
{
    /// <summary>
    /// Applies Retinues faction exports to an existing in-game faction, preserving upgrade links.
    /// </summary>
    public static class FactionImportService
    {
