// File: src/Retinues/Domain/Characters/Services/Import/CharacterImportService.cs
...
namespace Retinues.Domain.Characters.Services.Import
{
    /// <summary>
    /// Applies Retinues character exports to an existing in-game troop.
    /// </summary>
    public static class CharacterImportService
    {
        public static bool TryApplyCharacterExport(
            WCharacter target,
            Exports.Services.Import.CharacterExportEntry entry,
            out string error
        )
        {
            error = null;
