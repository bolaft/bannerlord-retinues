...
{
    [Serializable]
    public class PendingEquipData : BasePendingData
    {
        [SaveableField(4)]
    ...
    public sealed class TroopEquipBehavior : BaseUpgradeBehavior<PendingEquipData>
    {
        ...
        public static void StageEquipmentChange(WCharacter troop, EquipmentIndex slot, WItem item)
        {
            try
            {
                ...
                // Refresh town so the button updates immediately
        ...
        protected override string MenuId => "town";
            ...
            TimedWaitMenu.Start(
                ...
                onCompleted: () =>
                {
                    ...
                    Popup.Display(
                        ...
                        L.T("equip_complete_text", "{TROOP} has been equipped ({SLOT}).")
                            .SetTextVariable("TROOP", new WCharacter(troopId).Name)
                            .SetTextVariable("SLOT", slot.ToString())
                    );
                },
                onAborted: () => {
