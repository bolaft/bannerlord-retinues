...
namespace Retinues.Core.Game.Features.Doctrines.Catalog
{
    ...
    {
        public override string Name => "Pragmatic Scavengers";
        public override string Description => "Can unlock items from allied party casualties.";
        public override int Column => 0;
        public override int Row => 2;

        public sealed class PS_DefenseAllies50 : Feat
        {
            public override string Description => "Win a defensive battle in which allies suffer over 50% casualties.";
        ...
        {
            public override string Description => "While in an army, win a battle in which allies suffer over 50% casualties.";
            public override int Target => 1;
        ...
        {
            public override string Description => "Rescue a defeated lord from captivity.";
            public override int Target => 1;
