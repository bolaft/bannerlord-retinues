    ...
    public sealed class ClanicTraditions : Doctrine
    {
        ...
        public sealed class CT_OwnSmithy30Days : Feat
        {
            ...
            public override void OnDailyTick()
            {
                ...
                {
                    if (ws == null || ws.Settlement == null) continue;
                    if (ws.WorkshopType?.StringId != "smithy") continue;
                    if (ws.Settlement.Culture.StringId != Player.Culture.StringId) continue;
        ...
        public sealed class CT_Companions50Kills : Feat
        {
            ...
            {
                var companionKills = battle.Kills.Count(k => k.Killer.Character.IsHero && k.Killer.IsPlayerTroop);
        ...
        public sealed class CT_CompanionWins100BattleAsLeader : Feat
        {
            ...
            public override void OnSettlementOwnerChanged(SettlementOwnerChange change)
            {
                ...
                if (newOwner.HeroObject?.Clan?.StringId != Player.Clan.StringId) return;
