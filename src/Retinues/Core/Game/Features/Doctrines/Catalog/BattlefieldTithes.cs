...
namespace Retinues.Core.Game.Features.Doctrines.Catalog
{
    public sealed class BattlefieldTithes : Doctrine
    {
        ...
        public override string Description => L.S("battlefield_tithes_description", "Can unlock items from allied party kills.");
        public override int Column => 0;
        public override int Row => 1;

        public sealed class BT_QuestForAlliedLord : Feat
        {
            public override string Description => L.S("battlefield_tithes_quest_for_allied_lord", "Complete a quest for an allied lord.");
        ...
        {
            public override string Description => L.S("battlefield_tithes_save_allied_lord", "Save an allied lord from certain defeat.");
            public override int Target => 1;
        ...
        {
            public override string Description => L.S("battlefield_tithes_turn_tide_allied_army_battle", "Turn the tide of a battle involving an allied army.");
            public override int Target => 1;
