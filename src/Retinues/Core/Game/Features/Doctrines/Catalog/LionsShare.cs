...
namespace Retinues.Core.Game.Features.Doctrines.Catalog
{
    public sealed class LionsShare : Doctrine
    {
        ...
        public override string Description => L.S("lions_share_description", "Hero kills count twice for unlocks.");
        public override int Column => 0;
        public override int Row => 0;

        public sealed class LS_25PersonalKills : Feat
        {
            public override string Description => L.S("lions_share_25_personal_kills", "Personally defeat 25 enemies in one battle.");
        ...
        {
            public override string Description => L.S("lions_share_5_tier_5_plus", "Personally defeat 5 tier 5+ troops in one battle.");
        ...
        {
            public override string Description => L.S("lions_share_kill_enemy_lord", "Personally defeat an enemy lord in battle.");
