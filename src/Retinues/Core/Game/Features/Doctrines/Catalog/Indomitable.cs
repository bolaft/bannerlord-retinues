...
namespace Retinues.Core.Game.Features.Doctrines.Catalog
{
    public sealed class Indomitable : Doctrine
    {
        ...
        public override string Description => L.S("indomitable_description", "+20% retinue health.");
        public override int Column => 3;
        public override int Row => 0;

        public sealed class IND_25EquivNoCasualty : Feat
        {
            public override string Description => L.S("indomitable_25_equiv_no_casualty", "Have your retinues defeat 25 enemy troops of equivalent tier without a single casualty.");
        ...
        {
            public override string Description => L.S("indomitable_join_siege_defender_full_strength", "Fight a siege battle as a defender with at least 10 retinue troops and win.");
        ...
        {
            public override string Description => L.S("indomitable_win_3_defensive_battles", "Win 3 defensive battles in a row with a retinue-only party.");
