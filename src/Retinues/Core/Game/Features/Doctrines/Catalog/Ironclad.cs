...
namespace Retinues.Core.Game.Features.Doctrines.Catalog
{
    public sealed class Ironclad : Doctrine
    {
        ...
        public override string Description => L.S("ironclad_description", "No tier restriction for arms and armor.");
        public override int Column => 1;
        public override int Row => 3;

        public sealed class IC_FullSetT5Plus100Kills : Feat
        {
            public override string Description => L.S("ironclad_full_set_t5_plus_100_kills", "Equip a full set of tier 5+ items on a custom troop and have them get 100 kills in battle.");
        ...
        {
            public override string Description => L.S("ironclad_10_troops_athletics_80", "Have 10 custom troops reach 80 in Athletics skill.");
        ...
        {
            public override string Description => L.S("ironclad_100_battle_outnumbered_low_tier", "Win a 100+ battle, while outnumbered, and fielding only custom troops of tier 1, 2, or 3.");
