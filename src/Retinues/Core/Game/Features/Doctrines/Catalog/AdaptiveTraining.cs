...
namespace Retinues.Core.Game.Features.Doctrines.Catalog
{
    ...
    {
        public override string Name => "Adaptive Training";
        public override string Description => "Experience refunds for retraining.";
        public override int Column => 2;
        public override int Row => 3;

        public sealed class AT_200InEachSkill : Feat
        {
            public override string Description => "For each skill, have at least one custom troop with a level of 200 or higher.";
        ...
        {
            public override string Description => "Win a battle against over 100 enemies using a party evenly split among infantry, cavalry and ranged clan troops";
        ...
        {
            public override string Description => "Knock-out 50 opponents in tournaments.";
