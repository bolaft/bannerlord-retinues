...
namespace Retinues.Migration
{
    ...
    internal static class FeatKeyMap
    {
        internal readonly struct Mapping
        {
            ...
            /// <summary>v1 feat completion threshold (as declared in Retinues).</summary>
        ...
        private static readonly Dictionary<string, Mapping[]> _map = new(StringComparer.Ordinal)
        {
            ...
            ["Retinues.Doctrines.Catalog.LionsShare+LS_25PersonalKills"] = One(
                "feat_sp_blood_price",
                25,
                25
            ),
            ["Retinues.Doctrines.Catalog.LionsShare+LS_5Tier5Plus"] = One(
                "feat_sp_high_value_targets",
                5,
                5
            ),
            ["Retinues.Doctrines.Catalog.LionsShare+LS_KillEnemyLord"] = One(
            ...
            ["Retinues.Doctrines.Catalog.BattlefieldTithes+BT_QuestForAlliedLord"] = One(
                "feat_sp_allies_favor",
                5,
                1
            ),
            // BT_LeadArmyVictory (lead allied army to victory) ≈ feat_sp_second_in_command (win not as main commander)
            ["Retinues.Doctrines.Catalog.BattlefieldTithes+BT_LeadArmyVictory"] = One(
                "feat_sp_second_in_command",
                1,
                1
            ),
            ["Retinues.Doctrines.Catalog.BattlefieldTithes+BT_TurnTideAlliedArmyBattle"] =
            ...
            ["Retinues.Doctrines.Catalog.PragmaticScavengers+PS_Allies100Casualties"] = One(
                "feat_sp_costly_victory",
                100,
                1
            ),
            ["Retinues.Doctrines.Catalog.PragmaticScavengers+PS_AllyArmyWin3"] = One(
                "feat_sp_march_together",
                3,
                1
            ),
            ["Retinues.Doctrines.Catalog.PragmaticScavengers+PS_RescueLord"] = One(
            ...
            ["Retinues.Doctrines.Catalog.AncestralHeritage+AH_150OutnumberedOwnCulture"] =
                One("feat_sp_cultural_triumph", 1, 1),
            ["Retinues.Doctrines.Catalog.AncestralHeritage+AH_CaptureOwnCultureFief"] = One(
                "feat_sp_homecoming",
                1,
                1
            ),
            ...
            ["Retinues.Doctrines.Catalog.CulturalPride+CP_TournamentOwnCultureGear"] = One(
                "feat_eq_hometown_tournament",
                1,
                1
            ),
            ["Retinues.Doctrines.Catalog.CulturalPride+CP_FullSet100Kills"] = One(
                "feat_eq_proud_and_strong",
                100,
                100
            ),
            ["Retinues.Doctrines.Catalog.CulturalPride+CP_DefeatForeignRuler"] = One(
                "feat_eq_kingslayer",
                1,
                1
            ),
            ...
            ["Retinues.Doctrines.Catalog.RoyalPatronage+RP_Recruit100CustomKingdom"] = One(
                "feat_eq_royal_levy",
                100,
                100
            ),
            ["Retinues.Doctrines.Catalog.RoyalPatronage+RP_CompanionGovernor30Days"] = One(
                "feat_eq_royal_stewardship",
                30,
                30
            ),
            ["Retinues.Doctrines.Catalog.RoyalPatronage+RP_1000KillsCustomKingdom"] = One(
                "feat_eq_royal_host",
                1000,
                1000
            ),
            ...
            ["Retinues.Doctrines.Catalog.Ironclad+IC_FullSetT6100Kills"] = One(
                "feat_eq_ironmen",
                100,
                1
            ),
            ...
            ["Retinues.Doctrines.Catalog.StalwartMilitia+SM_DefendCityFromSiege"] = One(
                "feat_trp_defender_of_the_city",
                1,
                1
            ),
            ["Retinues.Doctrines.Catalog.StalwartMilitia+SM_PlayerKillsInSiegeDefense"] = One(
                "feat_trp_they_shall_not_pass",
                50,
                50
            ),
            ["Retinues.Doctrines.Catalog.StalwartMilitia+SM_RaiseMilitiaTo400"] = One(
            ...
            ["Retinues.Doctrines.Catalog.RoadWardens+RW_OwnThreeCaravans"] = One(
                "feat_trp_trade_network",
                3,
                3
            ),
            // RW_MerchantTownQuests: 3 quests for one merchant → feat_trp_merchants_favor: 10 total (repeatable)
            ["Retinues.Doctrines.Catalog.RoadWardens+RW_MerchantTownQuests"] = One(
                "feat_trp_merchants_favor",
                3,
                10
            ),
            ["Retinues.Doctrines.Catalog.RoadWardens+RW_ClearHideout"] = One(
            ...
            ["Retinues.Doctrines.Catalog.ArmedPeasantry+AP_DefendVillageOnlyCustom"] = One(
                "feat_trp_shield_of_the_people",
                1,
                1
            ),
            // AP_HeadmanVillageQuests / AP_LandownerVillageQuests: 3 cumulative → v2 repeatable Target=1 each
            ["Retinues.Doctrines.Catalog.ArmedPeasantry+AP_HeadmanVillageQuests"] = One(
                "feat_trp_headmans_help",
                3,
                1
            ),
            ["Retinues.Doctrines.Catalog.ArmedPeasantry+AP_LandownerVillageQuests"] = One(
            ...
            ["Retinues.Doctrines.Catalog.Captains+CP_MaxOutEliteAndBasic"] = Two(
            ...
            ["Retinues.Doctrines.Catalog.IronDiscipline+ID_Upgrade100BasicToMax"] = One(
                "feat_tr_forged_in_battle",
                100,
                100
            ),
            ["Retinues.Doctrines.Catalog.IronDiscipline+ID_LeadArmy10Days"] = One(
                "feat_tr_general",
                10,
                10
            ),
            ["Retinues.Doctrines.Catalog.IronDiscipline+ID_DefeatTwiceSizeOnlyCustom"] = One(
            ...
            ["Retinues.Doctrines.Catalog.SteadfastSoldiers+SS_TroopsMaxedSkills"] = One(
                "feat_tr_peak_performance",
                15,
                10
            ),
            ["Retinues.Doctrines.Catalog.SteadfastSoldiers+SS_SiegeDefenseOnlyCustom"] = One(
                "feat_tr_hold_the_walls",
                1,
                1
            ),
            ["Retinues.Doctrines.Catalog.SteadfastSoldiers+SS_RaiseSecurityTo60"] = One(
            ...
            ["Retinues.Doctrines.Catalog.MastersAtArms+MAA_Upgrade100EliteToMax"] = One(
                "feat_tr_distinguished_service",
                100,
                100
            ),
            ["Retinues.Doctrines.Catalog.MastersAtArms+MAA_KO50Opponents"] = One(
                "feat_tr_brawler",
                50,
                50
            ),
            ["Retinues.Doctrines.Catalog.MastersAtArms+MAA_1000EliteKills"] = One(
            ...
            ["Retinues.Doctrines.Catalog.AdaptiveTraining+AT_WinWithEvenSplit"] = One(
                "feat_tr_combined_arms",
                1,
                1
            ),
            // AT_5Weapons: high-water mark of weapon-class count in a battle → v2 binary completed
            ["Retinues.Doctrines.Catalog.AdaptiveTraining+AT_5Weapons"] = One(
            ...
            ["Retinues.Doctrines.Catalog.Indomitable+IND_25EquivNoCasualty"] = One(
                "feat_ret_flawless_execution",
                25,
                20
            ),
            // IND_JoinSiegeDefenderFullStrength: no close equivalent in indomitable
            ["Retinues.Doctrines.Catalog.Indomitable+IND_RetinueOnly3DefWins"] = One(
            ...
            ["Retinues.Doctrines.Catalog.BoundByHonor+BBH_ProtectVillagersOrCaravans"] = One(
                "feat_ret_safe_travels",
                3,
                1
            ),
            ["Retinues.Doctrines.Catalog.BoundByHonor+BBH_RetinueOnlyMorale90For15Days"] =
                One("feat_ret_high_spirits", 15, 15),
            ["Retinues.Doctrines.Catalog.BoundByHonor+BBH_Defeat10Bandits"] = One(
            ...
            ["Retinues.Doctrines.Catalog.Vanguard+VG_Win100RetinueOnly"] = One(
                "feat_ret_shock_assault",
                1,
                1
            ),
            ["Retinues.Doctrines.Catalog.Vanguard+VG_FirstMeleeKillInSiege"] = One(
            ...
            ["Retinues.Doctrines.Catalog.Immortals+IM_100RetinueSurviveStruckDown"] = One(
                "feat_ret_still_standing",
                100,
                20
            ),
            ["Retinues.Doctrines.Catalog.Immortals+IM_Win100NoDeaths"] = One(
            ...
            ["Retinues.Doctrines.Catalog.Immortals+IM_Retinue200Enemies"] = One(
