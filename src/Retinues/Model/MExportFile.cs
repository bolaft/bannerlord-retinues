...
{
    public sealed class MExportFile
    {
        ...
        public static MExportFile Create(string kind, string sourceId, IEnumerable<Entry> entries)
        {
        ...
        public static MExportFile FromXmlString(string xml)
        {
            ...
            if (root == null || root.Name.LocalName != "RetinuesExport")
                throw new InvalidDataException("Invalid export file: missing RetinuesExport root.");
        ...
        public static void SaveToPath(string path, MExportFile file)
        {
            if (file == null)
