...
Hovering an item shows the **vanilla tooltip** with stats as usual.
...
- For upgrade requirements, the system looks at the **best horse category** across your sets (battle/civilian/alternates) and may use it to gate **upgrades** to certain mounted units.
