...
- **Retinues:** special personal troops available **right away**.  
  ...
  → See: [Retinues](./doc/retinues.md)

- **Clan Troops:** unlocked when you **acquire your first fief**.  
  On unlock, choose to **start from scratch** or **clone the entire culture tree**.  
...
→ See: [Doctrines](./doc/doctrines.md)
